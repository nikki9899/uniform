...
const IndustrialUniform = ({ heading, description  }) => {
  ...
  return (
    <div className="mt-16 md:mt-32">
      <div className="md:mb-[44px] text-center text-black text-[30px] xs:text-[40px] sm:text-6xl lg:text-[115px] lg:leading-[80px] font-medium leading-7 md:leading-[66px] xs:tracking-[-1.5px] md:tracking-[-3px]  capitalize">
        <h1>{HeadingString}</h1>
      </div>
