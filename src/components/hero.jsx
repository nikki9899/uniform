...
function Hero({ hero }) {
    ...
    return (
        <div className="py-4 mt-20">
            ...
            <div className="text-center text-gray-900 text-xs sm:text-xl lg:text-3xl lg:font-normal lg:leading-6 font-medium  font-poppins leading-[26.645px] lowercase">
                <p>{description}</p>
            </div>
            <div className="text-center my-3 mt-7">
                <Button
                    variant="primary"
                    rounded="semi"
                    addStyle="bg-slate-300 text-gray-400 border-gray-900 opacity-25"
                >
