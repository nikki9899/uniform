...
const Footer = (props) => {
  let connectedPageLinks = {
    ...
    Shop: {
      title: "Shop",
      listItems: [
        { id: 1, item: "Commercial Uniform" },
        { id: 2, item: "Industrial Clothing" },
        { id: 3, item: "Hospital Uniforms" },
        { id: 4, item: "Corporate Uniform" },
        { id: 5, item: "Hotel Uniforms" },
      ],
    },
  };
    ...
    <div>
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            <FooterList contents={connectedPageLinks.quickLink} />
          </div>
          <div>
            <FooterList contents={connectedPageLinks.company} />
            <div className="mt-9">
              <FooterList contents={connectedPageLinks.customerService} />
            </div>
          </div>
          <div>
            <FooterList contents={connectedPageLinks.Shop} />
          </div>
          <div>
            <h2 className="mb-4 text-2xl font-medium text-gray-900  dark:text-white">
              Uniform on Web Newsletter
            </h2>
            <ul className="text-gray-900 dark:text-gray-400 font-normal">
              <li className="mb-4">
                <a href="#" className="hover:underline">
                  Get highlights of the most important news delivered to your
                  mail inbox
                </a>
              </li>
              <li className="mb-4">
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <button className="relative py-3 text-black">
                    Subscribe
